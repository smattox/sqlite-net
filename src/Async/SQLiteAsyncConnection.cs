...
namespace SQLite
{
    public partial class SQLiteAsyncConnection
    {
        ...
        public Task<CreateTablesResult> CreateTableAsync<T>(string contextName = null, CreateFlags createFlags = CreateFlags.None)
            where T : new()
        {
            return CreateTablesAsync(contextName, createFlags, typeof(T));
        }

        public Task<CreateTablesResult> CreateTablesAsync<T, T2>(string contextName = null, CreateFlags createFlags = CreateFlags.None)
            where T : new()
            where T2 : new()
        {
            return CreateTablesAsync(contextName, createFlags, typeof(T), typeof(T2));
        }

        public Task<CreateTablesResult> CreateTablesAsync<T, T2, T3>(string contextName = null, CreateFlags createFlags = CreateFlags.None)
            where T : new()
            where T2 : new()
            where T3 : new()
        {
            return CreateTablesAsync(contextName, createFlags, typeof(T2), typeof(T3));
        }

        public Task<CreateTablesResult> CreateTablesAsync<T, T2, T3, T4>(string contextName = null, CreateFlags createFlags = CreateFlags.None)
            where T : new()
            where T2 : new()
            where T3 : new()
            where T4 : new()
        {
            return CreateTablesAsync(contextName, createFlags, typeof(T2), typeof(T3), typeof(T4));
        }

        public Task<CreateTablesResult> CreateTablesAsync<T, T2, T3, T4, T5>(string contextName = null, CreateFlags createFlags = CreateFlags.None)
            where T : new()
            where T2 : new()
            where T3 : new()
            where T4 : new()
            where T5 : new()
        {
            return CreateTablesAsync(contextName, createFlags, typeof(T), typeof(T2), typeof(T3), typeof(T4), typeof(T5));
        }
